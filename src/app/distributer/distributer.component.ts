...
export class distributerComponent implements OnInit {
  ...
  constructor(private servicedistributer: distributerService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.servicedistributer.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'com.logisticprakash.distributer',
    ...
    return this.servicedistributer.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.servicedistributer.updateParticipant(form.get('participantKey').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.servicedistributer.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.servicedistributer.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
