...
export class farmerComponent implements OnInit {
  ...
  constructor(private servicefarmer: farmerService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'com.logisticprakash.farmer',
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.servicefarmer.updateParticipant(form.get('participantKey').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
